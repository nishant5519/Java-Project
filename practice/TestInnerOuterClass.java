...
class OuterClass {
	...
	private String non_static_variable="NonStatic";
	...
	public static class NestedStaticClass {
		...
		public void printMessage() {
			...
			// compiler error
			System.out.println("Message1 from nested static class: " + msg);
			}
	...
	public class InnerClass {
		...
		// this Inner class
		public void display() {
			System.out.println("Message1 from non-static nested class: " + msg);
			System.out.println("Message2 from nested static class: " + non_static_variable);
