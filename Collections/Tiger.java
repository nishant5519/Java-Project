...
public class Tiger {
	...
	public static void main(String args[]) {
		...
		Map<Tiger,Integer> hm=new HashMap<Tiger,Integer>();
		hm.put(bengalTiger1, 1);
		hm.put(bengalTiger2, 2);
		System.out.println(hm.get(bengalTiger1));
		System.out.println(hm.get(bengalTiger2));
	}
