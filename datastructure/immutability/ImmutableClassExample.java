...
public  class ImmutableClassExample {
	...
	//	 return testMap; //for shallow cloning
		 return (HashMap<String, String>) testMap.clone(); //for deep cloning
	...
	public static void main(String[] args) {
		...
		HashMap<String, String> hmTest = ce.getTestMap();//For deep cloning it creates a new separate object due to testMap.clone() method.
		hmTest.put("4", "new");
		...
		//////////Testing why Final class is required for immutability////////////////////
